...
var (
	...
	driverSvc         = flag.String("driver-svc", "http://{{$driverIP}}.{{$appNamespace}}.pod.cluster.local:4040", "Spark UI Service URL, this should point to the Spark driver service which provides Spark UI inside that driver.")
